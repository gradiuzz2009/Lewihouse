...
def seed_all():
    ...
    if write_doc("properties/lewi_house_main", property_info):
        print("  [✓] Property document 'lewi_house_main' created.")

    # 2. Rooms
    rooms = [
        {"id": "room_101", "roomNumber": "101", "floor": "1", "roomType": "deluxe", "capacity": 1, "monthlyPrice": 1500000.0, "deposit": 500000.0, "status": "OCCUPIED", "facilities": ["AC", "Kamar Mandi Dalam", "WiFi", "Kasur Queen", "Lemari"], "updatedAt": now},
        {"id": "room_102", "roomNumber": "102", "floor": "1", "roomType": "deluxe", "capacity": 1, "monthlyPrice": 1500000.0, "deposit": 500000.0, "status": "AVAILABLE", "facilities": ["AC", "Kamar Mandi Dalam", "WiFi", "Kasur Queen", "Lemari"], "updatedAt": now},
        {"id": "room_103", "roomNumber": "103", "floor": "1", "roomType": "standard", "capacity": 1, "monthlyPrice": 1200000.0, "deposit": 500000.0, "status": "AVAILABLE", "facilities": ["Kipas Angin", "Kamar Mandi Luar", "WiFi", "Kasur Single"], "updatedAt": now},
        {"id": "room_104", "roomNumber": "104", "floor": "1", "roomType": "standard", "capacity": 1, "monthlyPrice": 1200000.0, "deposit": 500000.0, "status": "AVAILABLE", "facilities": ["Kipas Angin", "Kamar Mandi Luar", "WiFi", "Kasur Single"], "updatedAt": now},
        {"id": "room_201", "roomNumber": "201", "floor": "2", "roomType": "vip", "capacity": 2, "monthlyPrice": 2000000.0, "deposit": 1000000.0, "status": "AVAILABLE", "facilities": ["AC", "Kamar Mandi Dalam", "Water Heater", "Balkon", "WiFi", "Smart TV"], "updatedAt": now},
        {"id": "room_202", "roomNumber": "202", "floor": "2", "roomType": "vip", "capacity": 2, "monthlyPrice": 2000000.0, "deposit": 1000000.0, "status": "AVAILABLE", "facilities": ["AC", "Kamar Mandi Dalam", "Water Heater", "Balkon", "WiFi", "Smart TV"], "updatedAt": now},
        {"id": "room_203", "roomNumber": "203", "floor": "2", "roomType": "standard", "capacity": 1, "monthlyPrice": 1200000.0, "deposit": 500000.0, "status": "AVAILABLE", "facilities": ["Kipas Angin", "Kamar Mandi Dalam", "WiFi"], "updatedAt": now},
        {"id": "room_204", "roomNumber": "204", "floor": "2", "roomType": "standard", "capacity": 1, "monthlyPrice": 1200000.0, "deposit": 500000.0, "status": "AVAILABLE", "facilities": ["Kipas Angin", "Kamar Mandi Dalam", "WiFi"], "updatedAt": now},
    ]
    for r in rooms:
