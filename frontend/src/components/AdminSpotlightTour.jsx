...
export const ADMIN_TOUR_STEPS = [
  ...
  {
    step_id: "leads_pipeline",
    badge: "LANGKAH 4 DARI 5",
    title: "Pipeline Calon Penyewa & Konversi 📥",
    subtitle: "Pencatatan Leads & Integrasi Listing Mamikos",
    description:
      "Catat prospek calon penyewa yang bertanya lewat Mamikos, WhatsApp, atau OLX. Saat calon penyewa deal, klik 'Konversi Jadi Penyewa' untuk membuat akun resmi dan mengunci status kamar secara instan.",
    features: [
      "Pencatatan manual cepat prospek dari WhatsApp / Mamikos / OLX",
      "Kanban board alur: Inquiry Baru ➔ Survei ➔ DP ➔ Konversi",
      "One-Click Conversion: Otomatis buat kredensial login & kunci kamar OCCUPIED",
    ],
    target_component_id: "tour-target-leads-pipeline",
    icon: TrendingUp,
    accentColor: "#059669",
    preferredPlacement: "top",
  },
